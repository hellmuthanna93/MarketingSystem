...
| AI tell | Fix |
|---------|-----|
| "In today's fast-paced world…" / "In a world where…" | Cut. Start with the reader's actual experience. |
| "It's important to note that…" / "It's worth mentioning…" | Cut the throat-clearing; say the thing. |
...
Read it aloud. If every sentence is the same length and shape, rewrite. Anna's real writing mixes a blunt 4-word line with a flowing 30-word one (see `business-site/docs/02-brand/07-voice-reference.md` for annotated examples from real blog posts).

## Final gate

If the draft could have been written by any coach about any practice, it has failed. It must only make sense coming from Anna: psychological depth + coaching practicality + lived experience + warmth + grounded certainty.
