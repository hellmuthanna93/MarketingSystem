...
```mermaid
flowchart LR
    overview[00 Overview] --> strategy[01 Strategy]
    strategy --> brand[02 Brand]
    brand --> offerings[03 Offerings]
    offerings --> marketing[04 Marketing]
    marketing --> sales[05 Sales]
    sales --> operations[06 Operations]
    operations --> finance[07 Finance and Legal]
    finance --> roadmap[08 Roadmap]
    roadmap --> toolkit[09 Toolkit]
```
