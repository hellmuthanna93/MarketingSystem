...
Warm, grounded, intelligent, calm, quietly confident, feminine. A specialist who has been there. Never hype-y, never clinical, never small.

## Positioning vs competitors (brand expression)

- Against motivational coaches: we have real psychological depth and refuse hype.
- Against clinical therapists: we are warm, forward-moving, and practical.
- Against app-based commodity therapy: we are personal, multilingual, and deep.
...
|---------|-----------------|
| Visual identity (color, type, components) | [brand/DESIGN.md](../../../brand/DESIGN.md) → [03-visual-identity.md](03-visual-identity.md) |
| Voice & tone | [brand/voice.md](../../../brand/voice.md) → [04-voice-and-tone.md](04-voice-and-tone.md) |
| Messaging & approved copy | [brand/marketing/messaging.md](../../../brand/marketing/messaging.md) → [05-messaging.md](05-messaging.md) |
| Voice evidence from real writing | [07-voice-reference.md](07-voice-reference.md) |
| Design system / components | [design-system/](../../../design-system/) → [08-design-system.md](08-design-system.md) |
