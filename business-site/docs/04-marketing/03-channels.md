...
Where Anna shows up, and the role each channel plays. Handles are canonical in `practice-profile`.
...
- Existing posts set the bar (burnout, counseling-vs-coaching, expat counseling, signs-you-need-support)
...
- TikTok: experimental; same reel scripts
- Facebook: maintain presence, low effort

## Multilingual approach

EN is the default. Use DE / UK / RU where it deepens resonance with a segment (e.g. Ukrainian/Russian for that community, German for local reach). Adapt idioms, don't translate word-for-word. Test Cyrillic and long German compounds in templates. Detail: [09-international-considerations.md](09-international-considerations.md).

## So what

Instagram + LinkedIn carry the present; blog/SEO and a future newsletter build the compounding, algorithm-resilient base. One insight feeds all of them. Lead gen mechanics: [04-lead-generation.md](04-lead-generation.md).
