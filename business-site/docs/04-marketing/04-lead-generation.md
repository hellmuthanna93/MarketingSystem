...
```mermaid
flowchart LR
    see[Sees content] --> resonate["Feels understood"]
    resonate --> profile[Visits profile / site]
    profile --> book[Books free discovery call]
    book --> recommend[Recommendation: wedge or package]
```
