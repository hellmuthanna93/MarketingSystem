...
- [ ] The client felt **precisely understood** (recognition happened)
- [ ] At least one real piece of movement, insight, or grounding occurred
- [ ] Anna stayed present and well-rested (not rushed/depleted)
- [ ] A clear next focus or step exists
...
- [ ] It names the pattern in plain, precise language the client recognizes
- [ ] It explains what keeps the pattern locked
- [ ] It shows where it appears in concrete life areas
- [ ] It recommends one clear next step (no hard sell)
...
- [ ] Passes the content checklist (relevance, specificity, authenticity, emotional connection, depth, business value)
- [ ] Leads with movement/recognition, not method/credentials
- [ ] One clear insight (not a list of tips)
- [ ] Voice and never-list respected; humanizer pass done
...
The quality bar is the brand made operational. Run the relevant checklist before anything reaches a client or the public. Reinforced by the `practice-voice` and `case-studies-anonymized` skills.
