...
> **Not legal or tax advice.** This is an orientation checklist for Anna's specific situation (a medical doctor offering psychological counseling and coaching online from Nuremberg). Confirm everything with a Steuerberater and a Rechtsanwalt. Practical marketing guardrails: `dach-mental-health-compliance` skill.

## The core scope question (decide this first)
...
As an MD, health advertising is HWG-sensitive: no cure/guarantee claims, no fear-based ads, careful use of testimonials (no disease-cure case histories). Detail: [../04-marketing/06-outreach-compliance-germany.md](../04-marketing/06-outreach-compliance-germany.md).

## Impressum & web compliance

- **Impressum** (already present) per §5 TMG / DDG, including professional title rules for doctors (Berufsbezeichnung, zuständige Kammer/Aufsichtsbehörde where applicable).
- Cookie/consent compliance on the website.
...
- [ ] Datenschutzerklärung covers all tools
- [ ] Impressum reflects professional-title rules
- [ ] Compliant invoice template ([../09-toolkit/08-invoice-template-germany.md](../09-toolkit/08-invoice-template-germany.md))
