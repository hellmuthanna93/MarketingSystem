...
- [ ] Ensure discovery-call CTA is on every site page + bio ([../04-marketing/05-website-plan.md](../04-marketing/05-website-plan.md))
- [ ] Confirm legal scope + agreement reviewed ([../07-finance-legal/01-legal-setup-germany.md](../07-finance-legal/01-legal-setup-germany.md))
...
- [ ] Publish the 12 LinkedIn launch posts ([../09-toolkit/03-linkedin-launch-posts.md](../09-toolkit/03-linkedin-launch-posts.md))
- [ ] Run the 90-day content calendar ([../09-toolkit/04-content-calendar-90day.md](../09-toolkit/04-content-calendar-90day.md))
- [ ] Publish 2 blog posts; repurpose into social ([../09-toolkit/13-blog-post-batch.md](../09-toolkit/13-blog-post-batch.md))
- [ ] Use the discovery-call script consistently ([../09-toolkit/01-discovery-call-script.md](../09-toolkit/01-discovery-call-script.md))
- [ ] Offer the wedge in discovery calls where it fits; track conversion
- [ ] Start a newsletter signup (double opt-in) + first lead magnet idea ([../04-marketing/04-lead-generation.md](../04-marketing/04-lead-generation.md))
...
- Consistent 1+1 weekly posts sustained for 12 weeks
- Wedge confirmed, sold, and delivered to first clients
- Discovery calls happening weekly without paid ads
- At least one newsletter capture live
- Free days protected
